    ...
    <div class="form-table-box">
      <el-form ref="infoForm" :rules="infoRules" :model="infoForm" label-width="120px">
        ...
        <el-form-item label="商品主页轮播图">
          ...
          :multiple="true"
          :data="uploadToken"
          :on-preview="loophandlePictureCardPreview1"
        ...
        <el-form-item v-if="radio == 1" label="默认规格">
          <template>
            <el-switch
              v-model="unitespec"
              @change="unitespecchange">
            </el-switch>
            </template>
          <!-- <el-button @click="abc" type="success">成功按钮</el-button> -->
          <div class="form-tip">
        ...
        <el-form-item v-if="radio == 1" label="商品规格">
          <el-row :gutter="3">
            <el-col :span="7" v-show="showFirst">
              ...
              <el-form-item v-for="(list, index) in dynamicFirstForm.list" :key="list.id">
            ...
            <el-col :span="7" v-show="showSecond">
              ...
              <el-form-item v-for="(list, index) in dynamicSecondForm.list" :key="list.id">
                <el-input v-model="list.value" @keyup.native="show()" :placeholder="'规格值'+index" style="width:80%;float:left;margin-top:5px;"></el-input>
            ...
            <el-col :span="7" v-show="showThird">
              ...
              <el-form-item v-for="(list, index) in dynamicThirdForm.list" :key="list.id">
                <!-- :key="list.key"
        ...
        <el-form-item label="划线价">
          ...
          <div class="form-tip">
            ...
            <span style="color:#ff6666;">默认为价格值的 1.25 倍</span>
          </div>
        </el-form-item>
...
export default {
  ...
  methods: {
    unitespecchange() {
      if (this.unitespec) {
        // console.log("默认");
        console.log(this.dynamicFirstForm);
        this.dynamicFirstForm.name = '规格'
        this.dynamicFirstForm.list[0].value = '常规'
        this.first1 = '规格'
        this.show()
        this.setallstock = 999
        this.SetAllStock()
      }else {
        // console.log("自定义");
        this.dynamicFirstForm.name = ''
        this.dynamicFirstForm.list[0].value = ''
        this.first1 = ''
        this.setallstock = ''
        // this.tableData = []
        this.show()
    ...
    // },
    changePrices() {
      this.GoodsExprice = (parseInt(this.GoodsPrice) * 1.22).toFixed(2)
    },
    SyncPrice() {
      ...
      this.changePrices()
      // this.GoodsExprice = (parseInt(minprice) * 1.30).toFixed(2)
