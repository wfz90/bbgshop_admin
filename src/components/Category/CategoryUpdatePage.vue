            ...
            <div class="form-table-box">
                <el-form ref="infoForm" :model="infoForm" label-width="180px">
                    <el-form-item label="上级分类">
                        <el-select :disabled="!infoForm.FirstClassifyId" v-model="infoForm.FirstClassifyId" placeholder="请选择上级分类">
                    ...
                    <el-form-item label="分类图片(首页)" v-if="infoForm.show_index">
                      <el-upload
...
<script>
  export default {
    ...
    methods: {
      ...
      || this.infoForm.index_catrgory_normal_imageUrl == '') {
          this.$message.error("分类信息不完整 ！")
          return false
        }
        if (this.infoForm.show_index && (this.infoForm.index_bar_imageUrl == '' || this.infoForm.Bar_jump_link_id == '')) {
